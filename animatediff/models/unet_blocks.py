    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, attention_mask=None):
        ...
        for attn, resnet, motion_module in zip(self.attentions, self.resnets[1:], self.motion_modules):
            ...
            hidden_states = motion_module(hidden_states, temb, encoder_hidden_states=encoder_hidden_states) \
                if motion_module is not None and self.use_motion_module else hidden_states
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, attention_mask=None):
        ...
        for resnet, attn, motion_module in zip(self.resnets, self.attentions, self.motion_modules):
            if self.training and self.gradient_checkpointing:
                ...
                if motion_module is not None and self.use_motion_module:
...
class CrossAttnUpBlock3D(nn.Module):
    ...
    def set_processor(self, processor: "CrossAttnUpBlock3DProcessor") -> None:
        r"""
    ...
    def forward(
        ...
        for i,(resnet, attn, motion_module) in enumerate(zip(self.resnets, self.attentions, self.motion_modules)):
            ...
            if hasattr(self,'processor') and hasattr(self,'save_feature') and self.save_feature:
                self.processor.save_hidden(hidden_states,self.module_name,i)
